...
class corner_data:
    ...
    def add_data(self, data: unit, data_time: unit, template_name):
        self.right[template_name] = data.right_coords
        self.left[template_name] = data.left_coords
        self.right_time[template_name] = data_time.right_coords
        self.left_time[template_name] = data_time.left_coords
...
##########################################
    ...
    def scatter_efficiency_vs_size(self, dimension, mark):
        ...
        C = plt.scatter(x, y_C)
        D = plt.scatter(x, y_D)
        plt.title("Success over Template " +
                  dimension + " (Mark " + mark + ")")
...
expected_positions = "G_expected_6-24.csv"
top_positions = "./Data V3/6-24/G_top_positions*/*Pattern*.csv"
top_times = "./Data V3/6-24/G_top_positions*/*Timing*.csv"
bottom_positions = "./Data V3/6-24/G_bottom_positions*/*Pattern*.csv"
bottom_times = "./Data V3/6-24/G_bottom_positions*/*Timing*.csv"
